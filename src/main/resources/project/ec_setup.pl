...
if ($promoteAction eq 'promote') {
    ...
    $batch->setProperty("/plugins/ECSCM/project/scm_types/@PLUGIN_KEY@", "File");
    
    # Create a configuration
    $batch->setProperty('/plugins/ECSCM/project/scm_cfgs/File/scmPlugin',
                        '@PLUGIN_KEY@');
    $batch->modifyProperty("/plugins/ECSCM/project/scm_cfgs/File", 
    ...
    $batch->deleteProperty("/plugins/ECSCM/project/scm_cfgs/File");
